...
const TouristsSpotsCard = ({touristsSpot}) => {
    const {_id,touristsSpotName,countryName,location,shortDescription,averageCost,seasonality,travelTime,totaVisitorsPerYear,userEmail,userName,photo} = touristsSpot;
    return (
        <div className="p-5 lg:p-0bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl h-auto">
            ...
            <div className="px-4 py-3">
                ...
                <Link to={`/viewDetails/${_id}`}><button className="mt-3 btn">View Details</button></Link>
            </div>
    </div>
